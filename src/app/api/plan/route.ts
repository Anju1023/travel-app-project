...
## 制約事項
- 旅行時期、行き先、スタイルを考慮して、必須アイテム以外に「あると便利なもの」を3〜5個 packingList に含めてください。
- その時期特有の服装の注意点や、現地でのマナー、混雑回避のコツなどを advice に2〜3個含めてください。
- 各スポット（観光地、レストラン、ホテルなど）の正確な緯度(lat)と経度(lng)を数値形式で含めてください。
- 日程は指定された日数分作成してください。
