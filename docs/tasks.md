...
- [ ] 🔍 検索連携機能 (クリックでGoogle検索)
  - [ ] `TimelineSection` のスポット名を Google 検索へのリンクに変更
  - [ ] `HotelSection` のホテル名を Google 検索へのリンクに変更
  - [ ] リンクには `target="_blank"` を設定して別タブで開くようにする

## 現在のステータス: 🚀 Phase 6 完了！さらに使いやすくなったよ、あんじゅ！✨

## 現在のステータス: 🛠️ 品質向上フェーズ継続中！もっと快適にしていこうね！
